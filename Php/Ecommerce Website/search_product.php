            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="chart.php"><i class="fa-solid fa-cart-shopping"></i><sup><?php cartItems() ?></sup></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="chart.php">Total Price: <?php totalCartPrice() ?>/-</a>
                        </li>
